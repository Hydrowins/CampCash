...
const BUDGET_ROWS = [
  {
    head: 'Institute & Hostel Fees',
    years: [120000, 100000, 100000, 100000, 100000],
    notes: 'Year 1 includes one-time fees & refundable deposits',
    mapsTo: 'Institute & Hostel Fees',
    group: 'Fixed Cost',
    variable: false,
  },
  {
    head: 'Mess / Food',
    years: [50000, 50000, 60000, 60000, 80000],
    notes: 'Paid to vendor per semester',
    mapsTo: 'Mess / Food',
    group: 'Fixed Cost',
    variable: false,
  },
  {
    head: 'Laptop + Mobile (one-time)',
    years: [200000, 0, 0, 0, 0],
    notes: 'Bought in Year 1',
    mapsTo: 'Laptop / Electronics',
    group: 'Personal',
    variable: true,
  },
  {
    head: 'Laptop upgrade / repair',
    years: [0, 0, 5000, 5000, 5000],
    notes: 'Optional buffer',
    mapsTo: 'Laptop / Electronics',
    group: 'Personal',
    variable: true,
  },
  {
    head: 'Studio Supplies / Stationery',
    years: [20000, 20000, 20000, 20000, 20000],
    notes: 'Sheets, pens, tools, adhesives',
    mapsTo: 'Studio Supplies / Stationery',
    group: 'Study Materials / Printing',
    variable: true,
  },
  {
    head: 'Printing / Plotting',
    years: [20000, 30000, 30000, 30000, 40000],
    notes: 'Submissions & juries',
    mapsTo: 'Printing / Plotting',
    group: 'Study Materials / Printing',
    variable: true,
  },
  {
    head: 'Model-Making / Fabrication',
    years: [10000, 10000, 10000, 20000, 20000],
    notes: 'Foamboard / MDF / 3D print / laser',
    mapsTo: 'Model-Making / Fabrication',
    group: 'Study Materials / Printing',
    variable: true,
  },
  {
    head: 'Books & References',
    years: [10000, 10000, 10000, 10000, 10000],
    notes: 'Purchased books / standards',
    mapsTo: 'Books & References',
    group: 'Study Materials / Printing',
    variable: true,
  },
  {
    head: 'Local Field Visits',
    years: [10000, 10000, 20000, 20000, 20000],
    notes: 'Local trips with college',
    mapsTo: 'Local Field Visits',
    group: 'Study Tours / Internships',
    variable: true,
  },
  {
    head: 'Major Study Tour (Year 2)',
    years: [0, 20000, 0, 0, 0],
    notes: 'When scheduled',
    mapsTo: 'Study Tour / Travel',
    group: 'Study Tours / Internships',
    variable: true,
  },
  {
    head: 'Major Study Tour (Year 4)',
    years: [0, 0, 0, 30000, 0],
    notes: 'When scheduled',
    mapsTo: 'Study Tour / Travel',
    group: 'Study Tours / Internships',
  ...
  {
    head: 'Competitions / Workshops',
    years: [10000, 20000, 20000, 20000, 20000],
    notes: 'Probable',
    mapsTo: 'Competitions / Workshops',
    group: 'Study Tours / Internships',
    variable: true,
  },
  {
    head: 'Health & Personal',
    years: [10000, 15000, 20000, 25000, 30000],
    notes: 'Medicines / tests',
    mapsTo: 'Health & Personal',
    group: 'Personal',
    variable: true,
  },
  {
    head: 'Local Commute',
    years: [10000, 15000, 20000, 25000, 30000],
    notes: 'Autos / cabs / buses',
    mapsTo: 'Local Commute',
    group: 'Personal',
    variable: true,
  },
  {
    head: 'Mobile / Internet & Subscriptions',
    years: [12000, 12000, 15000, 15000, 15000],
    notes: 'Data plans / cloud',
    mapsTo: 'Mobile / Internet & Subscriptions',
    group: 'Personal',
    variable: true,
  },
  {
    head: 'Home Travel (round trips)',
    years: [24000, 40000, 40000, 40000, 40000],
    notes: 'Adjust trips & per-trip cost',
    mapsTo: 'Home Travel',
    group: 'Personal',
    variable: true,
  },
  {
    head: 'Internship / Training (Year 4)',
    years: [0, 0, 0, 200000, 0],
    notes: 'Travel + stay + local commute',
    mapsTo: 'Internship / Training Expenses',
    group: 'Study Tours / Internships',
    variable: false,
  },
  {
    head: 'Portfolio / Placement (Year 5)',
    years: [0, 0, 0, 0, 20000],
    notes: 'Printing / portfolio',
    mapsTo: 'Portfolio / Placement',
    group: 'Study Materials / Printing',
    variable: false,
  },
  {
    head: 'Thesis Buffer (Year 5)',
    years: [0, 0, 0, 0, 20000],
    notes: 'Thesis peak spend',
    mapsTo: 'Thesis Expenses',
    group: 'Study Materials / Printing',
    variable: false,
  },
];
...
function monthLabel(year, monthNum1) {
  return new Date(year, monthNum1 - 1, 1).toLocaleDateString('en-US', {
    month: 'long',
    year: 'numeric',
  });
}
...
const SAMPLE_MONTH_TEMPLATES = [
  ...
  [
    ...
    },
    {
      day: 7,
      type: 'expense',
      category: 'Studio Supplies / Stationery',
      amount: 480,
      notes: 'Sheets and pens',
      method: 'Cash',
    },
    {
      day: 9,
      ...
      amount: 650,
      notes: 'Submission prints',
      method: 'UPI',
    },
    {
      day: 11,
      type: 'expense',
      category: 'Mobile / Internet & Subscriptions',
      amount: 399,
      notes: 'Recharge',
      method: 'UPI',
    },
    ...
    },
    {
      day: 18,
      type: 'expense',
      category: 'Model-Making / Fabrication',
      amount: 750,
      notes: 'Foam board + adhesive',
      method: 'Card',
    },
    {
      day: 21,
    ...
    },
    {
      day: 24,
      type: 'expense',
      category: 'Local Field Visits',
      amount: 400,
      notes: 'Site visit auto fare',
      method: 'Cash',
    },
    {
      day: 27,
...
export default function CampCash() {
    ...
    (async () => {
      try {
        ...
        if (raw && !cancelled) {
          ...
          if (typeof saved.accountName === 'string')
            setAccountName(saved.accountName);
          if (typeof saved.accountEmail === 'string')
          ...
          if (typeof saved.lastRolloverMonth === 'string')
            setLastRolloverMonth(saved.lastRolloverMonth);
          if (Array.isArray(saved.fds)) setFds(saved.fds);
          if (typeof saved.nextFdId === 'number') setNextFdId(saved.nextFdId);
          if (typeof saved.githubToken === 'string')
            setGithubToken(saved.githubToken);
          if (typeof saved.gistId === 'string') setGistId(saved.gistId);
          if (typeof saved.cloudConnected === 'boolean')
            setCloudConnected(saved.cloudConnected);
          if (typeof saved.cloudLastSyncedAt === 'string')
            setCloudLastSyncedAt(saved.cloudLastSyncedAt);
        }
      } catch (e) {
  ...
  useEffect(() => {
    ...
    let startKey =
      lastRolloverMonth && lastRolloverMonth < earliestKey
        ? lastRolloverMonth
        : earliestKey;
    ...
    while ((y < cy || (y === cy && m < cm)) && safety < 36) {
      ...
      if (closingBalance > 0.5) {
        ...
        newEntries.push({
          ...
          notes: `Balance carried forward to ${monthLabel(nextY, nextM)}`,
        });
        newEntries.push({
          id: idCounter++,
          date: inDate,
          ...
          amount: rounded,
          category: ROLLOVER_CATEGORY,
          notes: `Balance brought forward from ${monthLabel(y, m)}`,
        });
      }
  ...
  useEffect(() => {
    if (!dataLoaded || !cloudConnected || !gistId.trim() || !githubToken.trim())
      return;
  ...
  const isCurrentMonth = useMemo(() => {
    const now = new Date();
    return (
      periodMonthKey === `${now.getFullYear()}-${pad2(now.getMonth() + 1)}`
    );
  }, [periodMonthKey]);
  ...
  const periodLabel =
    periodMode === 'lifetime'
      ...
      ? 'This Month'
      : (() => {
          const [y, m] = periodMonthKey.split('-').map(Number);
  ...
  const periodIn = transactions
    .filter(
      (t) =>
        ...
        (periodMode === 'lifetime' ||
          monthKeyFromDate(t.date) === periodMonthKey)
    )
    ...
    () => [
      ...
      ...withBalance.map((t, i) => ({
        label: `${formatDate(t.date)}${
          i > 0 && withBalance[i - 1].date === t.date ? ' *' : ''
        }`,
  ...
  const scaledRows = useMemo(() => {
    ...
    return BUDGET_ROWS.map((row) => ({
      ...row,
      scaledYears: row.years.map((v) =>
        row.variable ? Math.round((v / BASE_SCENARIO_MULTIPLIER) * mult) : v
      ),
    }));
  }, [scenario]);
    ...
    return GROUPS.map((group) => ({
      ...
      years: [0, 1, 2, 3, 4].map((i) =>
        scaledRows
          ...
          .reduce((s, r) => s + r.scaledYears[i], 0)
      ),
    }));
  }, [scaledRows]);
  ...
  const budgetForYear = useMemo(() => {
    ...
    const byCategory = {};
    scaledRows.forEach((row) => {
      byCategory[row.mapsTo] =
        (byCategory[row.mapsTo] || 0) + row.scaledYears[idx];
    });
    return byCategory;
  ...
  const budgetForYearOne = useMemo(() => {
    ...
    scaledRows.forEach((row) => {
      byCategory[row.mapsTo] =
        (byCategory[row.mapsTo] || 0) + row.scaledYears[0];
    });
    return byCategory;
  }, [scaledRows]);
  ...
  const notifications = useMemo(() => {
    ...
    categories.forEach((cat) => {
      ...
      if (budgeted > 0 && actual > budgeted) {
        list.push({
          id: `over-${cat}`,
          tone: 'warning',
          text: `${cat} is over budget — ${formatMoney(
            actual
          )} logged against ${formatMoney(
            budgeted
          )} planned for Year 1 (${scenario}).`,
        });
      }
    });
    if (transactions.length > 0 && balance < monthlySetAside) {
      list.push({
        id: 'low-balance',
        tone: 'warning',
        text: `Your balance (${formatMoney(
          balance
        )}) is below your suggested monthly set-aside of ${formatMoney(
          monthlySetAside
        )}.`,
      });
    }
    if (transactions.length === 0) {
      list.push({
        id: 'welcome',
        tone: 'info',
        text: 'Log your first transaction on Home to start tracking against your budget.',
      });
    }
      ...
      .forEach((fd) => {
        ...
        if (maturityDate <= todayISO) {
          list.push({
            id: `fd-matured-${fd.id}`,
            tone: 'info',
            text: `Your FD "${fd.label}" matured on ${formatDate(
              maturityDate
            )} — mark it as matured on the Fixed Deposits tab to update your balance.`,
          });
        }
      });
    return list;
  ...
  const unseenNotifCount = notifications.filter(
    (n) => !seenNotifIds.has(n.id)
  ).length;
  ...
  function addTransaction({
    ...
    setTransactions((prev) => [
      ...prev,
      {
        ...
        notes: notes || '',
        ...(type === 'expense' && !isTransferCategory(category)
  ...
  function loadSampleData() {
    ...
    setNextId(idCounter);
    setSettingsMessage(
      `Loaded ${withIds.length} sample transactions across the last 3 months.`
    );
  }
  ...
  function addFD() {
    ...
    if (fdDebitOnCreate) {
      const usedId = addTransaction({
        ...
        notes: `Opened FD — ${fdLabel.trim()}`,
        dateOverride: fdStartDate,
      });
      if (!usedId) {
        setFdError(
          'That\'s more than your current balance — uncheck "debit from wallet" or adjust the amount.'
        );
        return;
      }
      debitedTxId = usedId;
    ...
    setFdRate('');
    setFdTenure('');
    setFdStartDate(new Date().toISOString().slice(0, 10));
    setFdCompounding('quarterly');
    setFdDebitOnCreate(true);
  }
  ...
  function startClosingFd(id, status, defaultAmount) {
    ...
    setClosingDraft({
      status,
      credit: true,
      amount: String(Math.round(defaultAmount)),
    });
  }
  ...
  const fdsWithComputed = useMemo(
    () =>
      fds
        .map((fd) => {
          const maturityDate = fdMaturityDate(fd.startDate, fd.tenureMonths);
          const maturityAmount = fdMaturityAmount(
            fd.principal,
            fd.rate,
            fd.tenureMonths,
            fd.compounding
  ...
  function exportJSONBackup() {
    ...
    a.href = url;
    a.download = `campcash-backup-${new Date()
      .toISOString()
      .slice(0, 10)}.json`;
  ...
  async function connectCloudSync() {
    ...
    try {
      if (!gistId.trim()) {
        ...
        setCloudSyncStatus('synced');
        setSettingsMessage(
          `Created a new sync gist (ID: ${newId}) — copy this ID into any other device to link it.`
        );
      } else {
        ...
        if (remote && Array.isArray(remote.transactions)) {
          ...
          setCloudSyncStatus('synced');
          setSettingsMessage(
            'Connected — this gist was empty, so your current wallet was pushed to it.'
          );
        }
        setCloudConnected(true);
      }
      ...
      setCloudSyncStatus('error');
      setSettingsMessage(
        "Couldn't reach GitHub — check the token and Gist ID and try again."
      );
    }
  }
  ...
  function disconnectCloudSync() {
    ...
    setSettingsMessage(
      'Cloud sync disconnected. Your data stays local — the gist itself is untouched.'
    );
  }
  ...
  function exportExcel() {
    ...
    const totalSpend = Object.values(actualByCategory).reduce(
      (a, b) => a + b,
      0
    );
    const spendPivotRows = spendingChartData.map((c) => ({
      ...
      '% of Total Spend': totalSpend
        ? Math.round((c.value / totalSpend) * 1000) / 10
        : 0,
    }));
    XLSX.utils.book_append_sheet(
      wb,
      XLSX.utils.json_to_sheet(spendPivotRows),
      'Pivot - Spend by Category'
    );

    // --- Pivot: Income by Source ---
    const totalIncome = Object.values(actualBySource).reduce(
      (a, b) => a + b,
      0
    );
    const incomePivotRows = incomeChartData.map((c) => ({
      ...
      '% of Total Income': totalIncome
        ? Math.round((c.value / totalIncome) * 1000) / 10
        : 0,
    }));
    XLSX.utils.book_append_sheet(
      wb,
      XLSX.utils.json_to_sheet(incomePivotRows),
      'Pivot - Income by Source'
    );
    ...
    const methodPivotRows = Object.entries(methodMap)
      ...
      .map(([method, v]) => ({
        ...
        '% of Total Spend': totalSpend
          ? Math.round((v.total / totalSpend) * 1000) / 10
          : 0,
      }));
    XLSX.utils.book_append_sheet(
      wb,
      XLSX.utils.json_to_sheet(methodPivotRows),
      'Pivot - Payment Method'
    );
    ...
    const monthlyPivotRows = Object.keys(monthMap)
      .sort()
      .map((key) => {
    ...
    XLSX.utils.book_append_sheet(
      wb,
      XLSX.utils.json_to_sheet(monthlyPivotRows),
      'Pivot - Monthly Summary'
    );

    // --- Budget vs Actual (Year 1, current scenario) ---
    const budgetRows = categories
      .filter((c) => c !== 'Transport / Other')
      .map((cat) => {
        const budgeted = budgetForYearOne[cat] || 0;
        const actual = actualByCategory[cat] || 0;
        return {
      ...
      .filter(
        (r) => r['Actual Logged'] > 0 || r[`Budgeted (Year 1, ${scenario})`] > 0
      );
    XLSX.utils.book_append_sheet(
      wb,
    ...
    const summaryRows = [
      ...
      {
        Metric: 'Exported On',
        Value: new Date().toLocaleString(currency.locale),
      },
    ...
    XLSX.writeFile(
      wb,
      `campcash-export-${new Date().toISOString().slice(0, 10)}.xlsx`
    );
    setSettingsMessage(
      'Excel workbook exported with Ledger + pivot-style analysis sheets.'
    );
  }
  ...
  function confirmRestore() {
    ...
    if (Array.isArray(saved.transactions)) {
      setTransactions(saved.transactions);
      const maxId = saved.transactions.length
        ? Math.max(...saved.transactions.map((t) => t.id || 0))
        : 0;
    ...
    if (saved.account) {
      if (typeof saved.account.name === 'string')
        setAccountName(saved.account.name);
      if (typeof saved.account.email === 'string')
        setAccountEmail(saved.account.email);
    }
    if (typeof saved.scenario === 'string') setScenario(saved.scenario);
    if (typeof saved.lastRolloverMonth === 'string')
      setLastRolloverMonth(saved.lastRolloverMonth);
    if (Array.isArray(saved.fds)) setFds(saved.fds);
    if (typeof saved.nextFdId === 'number') setNextFdId(saved.nextFdId);
    if (restoreSource === 'cloud')
      setCloudLastSyncedAt(saved.savedAt || new Date().toISOString());
    setPendingRestore(null);
    setRestoreConfirming(false);
    setSettingsMessage(
      restoreSource === 'cloud' ? 'Cloud data loaded.' : 'Backup restored.'
    );
  }
    ...
    reader.onload = () => {
      try {
        ...
        rows.slice(1).forEach((r) => {
          ...
          const type = ['income', 'in', 'credit'].includes(rawType)
            ? 'income'
            : ['expense', 'out', 'debit'].includes(rawType)
            ? 'expense'
            : null;
    ...
    try {
      ...
      const html = `
        <html>
          ...
          <body>
            <h1>CampCash — Account Summary${
              accountName ? ' for ' + accountName : ''
            }</h1>
            <div class="muted">Generated ${new Date().toLocaleString(
              currency.locale
            )}</div>
            <div class="stats">
              <div class="stat"><div class="label">Current Balance</div><div class="value">${formatMoney(
                balance
              )}</div></div>
              <div class="stat"><div class="label">Money In</div><div class="value">${formatMoney(
                periodIn
              )}</div></div>
              <div class="stat"><div class="label">Money Out</div><div class="value">${formatMoney(
                periodOut
              )}</div></div>
            </div>
            <table>
              ...
              <tbody>${
                rows ||
                '<tr><td colspan="7" style="text-align:center;color:#737373">No transactions logged yet.</td></tr>'
              }</tbody>
            </table>
          </body>
        </html>
  ...
  return (
    <div
      className={`min-h-screen w-full ${bg} ${text} font-sans flex`}
      style={{ fontFamily: "'Inter', 'Segoe UI', system-ui, sans-serif" }}
    >
      {/* Sidebar */}
      <aside
        className={`hidden md:flex w-56 shrink-0 border-r ${border} ${sidebarBg} flex-col justify-between py-6 px-4`}
      >
        <div>
        ...
        <div className="flex flex-col gap-3">
          <div
            className={`flex items-center gap-2 px-3 text-[11px] ${textMuted}`}
          >
            <span
          ...
          <div className="relative">
            <button
              ...
              className={`w-full rounded-lg border ${border} px-3 py-2.5 flex items-center gap-2 text-left hover:${
                dark ? 'bg-neutral-900' : 'bg-neutral-50'
              }`}
            >
              ...
              <div className="leading-tight">
                <div className={`text-[11px] ${textMuted}`}>
                  {periodMode === 'lifetime' ? 'Viewing' : 'Viewing Month'}
                </div>
            ...
            {periodOpen && (
              <div
                className={`absolute left-0 bottom-full mb-2 z-20 w-64 rounded-lg border ${border} ${cardBg} shadow-lg p-3`}
              >
                ...
                {periodMode === 'month' && (
                  <input
                    ...
                    onChange={(e) =>
                      e.target.value && setPeriodMonthKey(e.target.value)
                    }
          ...
          >
            ...
            <span
              className={`w-8 rounded-full relative transition-colors ${
                dark ? 'bg-blue-500' : 'bg-neutral-300'
              }`}
              style={{ height: 18 }}
            >
              <span
      ...
      {/* Mobile bottom nav */}
      <nav
        className={`md:hidden fixed bottom-0 inset-x-0 z-20 border-t ${border} ${sidebarBg} flex items-stretch justify-around px-1`}
      >
      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 sm:px-8 py-6 pb-24 md:pb-6 w-full">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-4 relative">
            <div className="relative">
              ...
              {notifOpen && (
                <div
                  className={`absolute right-0 top-8 z-20 w-80 max-w-[85vw] max-h-80 overflow-y-auto rounded-lg border ${border} ${cardBg} shadow-lg py-2`}
                >
                  <div
                    className={`px-3 pb-2 text-[12px] font-semibold ${textMuted}`}
                  >
                    Notifications
                  </div>
                  {notifications.length === 0 ? (
                    <div
                      className={`px-3 py-4 text-[13px] ${textMuted} text-center`}
                    >
                    ...
                    notifications.map((n) => (
                      <div
                        key={n.id}
                        className={`px-3 py-2 text-[12.5px] flex items-start gap-2 ${rowHover}`}
                      >
                        <span
                          className={`mt-1 w-1.5 h-1.5 rounded-full shrink-0 ${
                            n.tone === 'warning' ? 'bg-red-500' : 'bg-blue-500'
                          }`}
                        />
                        <span>{n.text}</span>
                      </div>
            ...
            <div className="relative">
              ...
              {menuOpen && (
                <div
                  className={`absolute right-0 top-8 z-20 w-56 max-w-[85vw] rounded-lg border ${border} ${cardBg} shadow-lg py-1`}
                >
                  <button
                    onClick={() => {
                      setDark((d) => !d);
        ...
        <div className="md:hidden relative mb-4">
          ...
          {periodOpen && (
            <div
              className={`absolute left-0 top-full mt-2 z-20 w-64 max-w-[85vw] rounded-lg border ${border} ${cardBg} shadow-lg p-3`}
            >
              <div className="flex items-center gap-2 mb-3">
                <button
                  onClick={() => setPeriodMode('month')}
        ...
        {activeView === 'home' && (
          <>
            ...
            <div className="rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 px-5 sm:px-7 py-6 flex items-center justify-between mb-5 shadow-sm">
              <div>
                <div className="text-blue-100 text-[12px] font-medium tracking-wide uppercase mb-2">
                  Current Balance
                </div>
                <div className="text-white text-3xl sm:text-4xl font-bold tracking-tight mb-3">
                  {formatMoney(balance)}
                </div>
            ...
            {/* Stats row */}
            <div
              className={`rounded-2xl border ${border} ${cardBg} px-6 py-5 mb-5 grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x ${
            ...
            >
              ...
              <div className="flex items-center gap-3 pl-4">
                ...
                <div>
                  ...
                  <div className="text-lg font-bold">
                    {formatMoney(periodIn - periodOut)}
                  </div>
                  <div className={`text-[11px] ${textMuted}`}>
                    {periodLabel}
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
              <div
                className={`rounded-2xl border ${
                  dark
                    ? 'border-green-900 bg-green-500/5'
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="font-semibold text-[14px] text-green-700">
                      Add Money
                    </div>
                ...
                <label
                  className={`text-[12px] font-medium ${textMuted} mb-1 block`}
                >
                  Amount
                </label>
                <div
                  className={`flex items-center rounded-lg border ${inputBg} px-3 mb-3`}
                >
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="font-semibold text-[14px] text-red-700">
                      Spend Money
                    </div>
                    <div className={`text-[12px] ${textMuted}`}>
            ...
            {/* Quick add */}
            <div
              className={`rounded-2xl border ${border} ${cardBg} px-6 py-4 mb-5 flex items-center justify-between flex-wrap gap-3`}
            >
              <div className="flex items-center gap-3 flex-wrap">
                ...
                {[100, 500, 1000].map((a) => (
                  ...
                  >
                    + {currency.symbol}
                    {a.toLocaleString(currency.locale)}
                  </button>
                ))}
                <span
                  className={`w-px h-5 ${
            ...
            >
              <div className="flex items-center justify-between px-6 py-4 flex-wrap gap-3">
                ...
                <div className="flex items-center gap-2 relative">
                  <div
                    className={`flex items-center gap-2 rounded-lg border ${inputBg} px-3 py-1.5`}
                  >
                  ...
                  {filterOpen && (
                    <div
                      className={`absolute right-0 top-11 z-10 w-64 max-w-[85vw] max-h-72 overflow-y-auto rounded-lg border ${border} ${cardBg} shadow-lg py-1`}
                    >
                      <button
                        onClick={() => {
                          setFilterCategory('All');
                        ...
                        className={`w-full text-left px-3 py-2 text-[13px] ${rowHover} ${
                          filterCategory === 'All'
                      ...
                      <div
                        className={`px-3 pt-2 pb-1 text-[11px] font-medium ${textMuted}`}
                      >
                        Income sources
                      </div>
                      {sources.map((h) => (
                      ...
                      <button
                        onClick={() => {
                          setFilterCategory(ROLLOVER_CATEGORY);
                          setFilterOpen(false);
                        }}
                        className={`w-full text-left px-3 py-2 text-[13px] ${rowHover} ${
                          filterCategory === ROLLOVER_CATEGORY
                            ? 'text-blue-500 font-medium'
                            : ''
                        }`}
                      >
                      ...
                      <button
                        onClick={() => {
                          setFilterCategory(FD_CATEGORY);
                          setFilterOpen(false);
                        }}
                        className={`w-full text-left px-3 py-2 text-[13px] ${rowHover} ${
                          filterCategory === FD_CATEGORY
                            ? 'text-blue-500 font-medium'
                            : ''
                        }`}
                      >
                  ...
                  <tbody>
                    {displayList.length === 0 && (
                      <tr>
                        <td
                          colSpan={6}
                          className={`text-center py-8 text-[13px] ${textMuted}`}
                        >
                          {transactions.length === 0 ? (
                            <div className="flex flex-col items-center gap-2">
                              <span>
                                No transactions yet — add one above to get
                                started.
                              </span>
                              <button
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-5 mb-5">
              <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
                <div className={`text-[12px] ${textMuted} mb-1`}>
                  Active FDs
                </div>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="font-semibold text-[14px] text-blue-700">
                    Add Fixed Deposit
                  </div>
                  <div className={`text-[12px] ${textMuted}`}>
                    Track a new FD and optionally debit it from your wallet
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-3">
                ...
                <div>
                  ...
                  <div
                    className={`flex items-center rounded-lg border ${inputBg} px-3`}
                  >
                    <span className={textMuted}>{currency.symbol}</span>
                    <input
                      type="number"
              ...
              <label className="flex items-center gap-2 text-[13px] mb-4 cursor-pointer">
                <input
                  type="checkbox"
                  checked={fdDebitOnCreate}
                  onChange={(e) => setFdDebitOnCreate(e.target.checked)}
                  className="w-4 h-4"
                />
            ...
            {fdsWithComputed.length === 0 ? (
              <div
                className={`rounded-2xl border ${border} ${cardBg} p-10 text-center`}
              >
                ...
                <div className={`text-[13px] ${textMuted}`}>
                  Add one above to start tracking it toward maturity.
                </div>
              </div>
            ) : (
                ...
                {fdsWithComputed.map((fd) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3 mb-3 flex-wrap">
                      <div>
                        ...
                        <div className={`text-[12px] ${textMuted} mt-0.5`}>
                          {formatMoney(fd.principal)} at {fd.rate}% (
                          {fd.compounding}) · {formatDate(fd.startDate)} →{' '}
                    ...
                    {fd.status === 'active' ? (
                      <>
                        <div
                          className={`w-full h-2 rounded-full ${trackBg} overflow-hidden mb-2`}
                        >
                          <div
                            className="h-full rounded-full bg-blue-500"
                            style={{ width: `${fd.progressPct}%` }}
                          />
                        </div>
                        <div className="flex items-center justify-between text-[12px] mb-4">
                          <span className={textMuted}>
                            {fd.progressPct}% of tenure elapsed
                          </span>
                          <span>
                            Expected:{' '}
                            ...
                            <span className="text-green-600">
                              {' '}
                              (+{formatMoney(fd.expectedInterest)})
                            </span>
                          </span>
                        </div>
                        {closingFdId === fd.id ? (
                          <div className={`rounded-lg border ${border} p-3`}>
                            ...
                            <label
                              className={`text-[11px] font-medium ${textMuted} mb-1 block`}
                            >
                              Payout amount
                            </label>
                            <div
                              className={`flex items-center rounded-lg border ${inputBg} px-3 mb-2`}
                            >
                              <span className={textMuted}>
                                {currency.symbol}
                              </span>
                            ...
                            <div className="flex items-center gap-2">
                              <button
                                onClick={confirmCloseFd}
                                className="px-3 py-1.5 rounded-lg text-[13px] font-medium bg-blue-600 text-white hover:bg-blue-700"
                              >
                                Confirm
                              </button>
                              <button
                                onClick={cancelClosingFd}
                                className={`px-3 py-1.5 rounded-lg text-[13px] font-medium border ${border} ${textMuted}`}
                              >
                                Cancel
                              </button>
                            </div>
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <button
                              onClick={() =>
                                startClosingFd(fd.id, 'withdrawn', fd.principal)
                              }
                              className={`px-3 py-1.5 rounded-lg text-[12.5px] font-medium border ${border} ${textMuted} hover:${
                                dark ? 'bg-neutral-800' : 'bg-neutral-50'
                              }`}
                            >
                              Withdraw Early
                      ...
                      <div className="text-[12.5px]">
                        <span className={textMuted}>
                          Closed {formatDate(fd.closedDate)} — payout{' '}
                        </span>
                        <span className="font-semibold">
                          {formatMoney(fd.payoutAmount)}
                        </span>
                        <span className={textMuted}>
                          {fd.credited
                            ? ' · credited to wallet'
                            : ' · not credited to wallet'}
                        </span>
                      </div>
                    )}
                  </div>
          ...
          <>
            ...
            <div className={`rounded-2xl border ${border} ${cardBg} p-5 mb-5`}>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className={`text-[12px] ${textMuted}`}>
                  Applies to personal & travel variable costs only
                </span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-5">
              <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
                ...
                <div className={`text-[11px] ${textMuted} mt-1`}>
                  {SCENARIO_MULTIPLIERS[scenario]}x on variable costs
                </div>
              </div>
              <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
                <div className={`text-[12px] ${textMuted} mb-1`}>
              ...
              <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
                ...
                <div className="text-2xl font-bold">
                  {formatMoney(monthlySetAside)}
                </div>
                <div className={`text-[11px] ${textMuted} mt-1`}>
                  5-year total ÷ 60 months
                </div>
              </div>
            </div>
            ...
            <div className={`rounded-2xl border ${border} ${cardBg} p-5 mb-5`}>
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-3xl font-bold">
                  {formatMoney(yearTotals[budgetYear - 1])}
                </span>
                <span className={`text-[13px] ${textMuted}`}>
                  budgeted for Year {budgetYear} at {scenario}
                </span>
              </div>
            </div>
            ...
            {/* Group summary */}
            <div
              className={`rounded-2xl border ${border} ${cardBg} overflow-hidden mb-5`}
            >
              <div className="px-6 py-4">
                <span className="font-semibold text-[15px]">
                  Spending Groups — Year {budgetYear}
                </span>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-[13.5px]">
                  ...
                  <tbody>
                    {groupTotals.map((g) => (
                      ...
                      >
                        ...
                        <td className="py-3">
                          {formatMoney(g.years[budgetYear - 1])}
                        </td>
                        <td className={`py-3 ${textMuted}`}>
                          {formatMoney(g.years.reduce((a, b) => a + b, 0))}
                        </td>
                      </tr>
                    ))}
                  </tbody>
            ...
            >
              <div className="px-6 py-4">
                <span className="font-semibold text-[15px]">
                  Budgeted vs Logged — Year {budgetYear}
                </span>
                <div className={`text-[12px] ${textMuted} mt-0.5`}>
                  Comparing the {scenario} plan against what you've actually
                  logged in the ledger so far
                </div>
              </div>
              <div className="px-6 pb-5 flex flex-col gap-3">
                {categories
                  ...
                  .map((cat) => {
                    ...
                    const pct =
                      budgeted > 0
                        ? Math.min(100, (actual / budgeted) * 100)
                        : 100;
                    ...
                    return (
                      <div key={cat}>
                        ...
                        <div
                          className={`w-full h-2 rounded-full ${trackBg} overflow-hidden`}
                        >
                          <div
                ...
                {Object.keys(actualByCategory).length === 0 && (
                  <div className={`text-[13px] ${textMuted} text-center py-4`}>
                    Log a few expenses on the Home tab to see them compared
            ...
            >
              <div className="px-6 py-4">
                <span className="font-semibold text-[15px]">
                  Full Cost Head Breakdown — {scenario}
                </span>
                <div className={`text-[12px] ${textMuted} mt-0.5`}>
                  From your uploaded College_Budget.xlsx — Budget sheet,
                  rescaled to the selected scenario
                </div>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-[13px]">
                  <thead>
                    <tr className={`border-t border-b ${border} ${textMuted}`}>
                      ...
                      <th className="text-left font-medium py-2.5 pr-6">
                        Notes
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {scaledRows.map((row) => (
                      ...
                      >
                        ...
                        <td className="py-2.5">
                          {formatMoney(row.scaledYears[budgetYear - 1])}
                        </td>
                        <td className={`py-2.5 ${textMuted}`}>
                          {formatMoney(
                            row.scaledYears.reduce((a, b) => a + b, 0)
                          )}
                        </td>
                        <td className={`py-2.5 pr-6 ${textMuted}`}>
                          {row.notes}
                        </td>
                      </tr>
                    ))}
          ...
          <>
            {transactions.length === 0 ? (
              ...
              >
                ...
                <div className={`text-[13px] ${textMuted} mb-3`}>
                  Log a few entries on the Home tab and trends will show up
                  here.
                </div>
                <button
                  onClick={loadSampleData}
                  className="text-blue-600 text-[13px] font-medium hover:text-blue-700"
                >
              ...
              <>
                {/* Balance trend */}
                <div
                  className={`rounded-2xl border ${border} ${cardBg} p-5 mb-5`}
                >
                  <div className="font-semibold text-[15px] mb-1">
                    Balance Trend
                  </div>
                  <div className={`text-[12px] ${textMuted} mb-4`}>
                    Running balance after every logged transaction, in order
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                  ...
                  <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
                    ...
                    <div className={`text-[12px] ${textMuted} mb-4`}>
                      {periodLabel} — per header
                    </div>
                    {periodSpendingChartData.length === 0 ? (
                      <div
                        className={`text-[13px] ${textMuted} py-10 text-center`}
                      >
                        No expenses logged{' '}
                        {periodMode === 'lifetime'
                          ? 'yet'
                      ...
                      <div
                        style={{
                          ...
                          height: Math.max(
                            180,
                            periodSpendingChartData.length * 32
                          ),
                        }}
                      >
                        <ResponsiveContainer>
                          <BarChart
                            data={periodSpendingChartData}
                            layout="vertical"
                    ...
                    {periodIncomeChartData.length === 0 ? (
                      ...
                      <div
                        style={{
                          ...
                          height: Math.max(
                            180,
                            periodIncomeChartData.length * 32
                          ),
                        }}
                      >
                        <ResponsiveContainer>
                          <BarChart
                            data={periodIncomeChartData}
                            layout="vertical"
                            margin={{ left: 8, right: 20, top: 4, bottom: 4 }}
                          >
                            <CartesianGrid
                ...
                <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
                  ...
                  <div className={`text-[12px] ${textMuted} mb-4`}>
                    {periodLabel} — share of spend held by each category
                  </div>
                  {periodSpendingChartData.length === 0 ? (
                    <div
                      className={`text-[13px] ${textMuted} py-10 text-center`}
        ...
        {activeView === 'settings' && (
          <div className="flex flex-col gap-5">
            <div
              className={`rounded-lg border ${border} ${cardBg} text-[12px] ${textMuted} px-4 py-2.5 flex items-center gap-2`}
            >
              <span
                className={`w-1.5 h-1.5 rounded-full ${
                  saveStatus === 'saving'
              ...
              {saveStatus === 'saving'
                ? 'Saving your changes…'
                : saveStatus === 'error'
                ? "Couldn't save just now — your changes are still on screen, will retry shortly."
                : saveStatus === 'saved'
                ? 'Everything below is saved automatically to this browser.'
                : 'Loading your saved wallet…'}
            </div>
            ...
            {settingsMessage && (
              <div
                className={`rounded-lg border ${
                  dark
                    ? 'border-blue-900 bg-blue-500/10 text-blue-300'
                    : 'border-blue-200 bg-blue-50 text-blue-700'
                } text-[13px] px-4 py-2.5 flex items-center justify-between`}
              >
                {settingsMessage}
                <button
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-[13px] font-medium bg-amber-600 text-white hover:bg-amber-700"
                  >
                    {restoreSource === 'cloud'
                      ? 'Load Cloud Data'
                      : 'Restore & Overwrite'}
            ...
            <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className={`text-[12px] ${textMuted}`}>
                    Local profile only — no cloud sync yet
                  </div>
                </div>
              </div>
            ...
            <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  onClick={() => setDark((d) => !d)}
                  className={`w-11 rounded-full relative transition-colors ${
                    dark ? 'bg-blue-500' : 'bg-neutral-300'
                  }`}
                  style={{ height: 22 }}
                >
            ...
            <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
              ...
              <div className={`text-[12px] ${textMuted} mb-4`}>
                Added on top of your logged transactions to calculate your
                current balance — useful if you're starting mid-way through the
                year
              </div>
              <div className="flex items-center gap-3">
                <div
                  className={`flex items-center rounded-lg border ${inputBg} px-3 flex-1 max-w-xs`}
                >
                  <span className={textMuted}>{currency.symbol}</span>
                  <input
                    type="number"
            ...
            <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
              ...
              <div className={`text-[12px] ${textMuted} mb-4`}>
                Add or remove the headers that show up in Add Money / Spend
                Money
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <button
                      onClick={addSourceHeader}
                      className="px-3 py-1.5 rounded-lg text-[13px] font-medium bg-green-600 text-white hover:bg-green-700"
                    >
                      Add
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-3">
                    {categories.map((c) => (
                      ...
                      >
                        {c}
                        <button
                          onClick={() => removeCategoryHeader(c)}
                          className="hover:opacity-70"
                        >
                          ×
                        </button>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onKeyDown={(e) =>
                        e.key === 'Enter' && addCategoryHeader()
                      }
                      placeholder="New category"
                      className={`flex-1 rounded-lg border ${inputBg} px-3 py-1.5 text-[13px] outline-none`}
                    />
                    <button
                      onClick={addCategoryHeader}
                      className="px-3 py-1.5 rounded-lg text-[13px] font-medium bg-red-500 text-white hover:bg-red-600"
                    >
                      Add
                    </button>
                  </div>
              ...
              <div className={`text-[11px] ${textMuted} mt-3`}>
                Removing a category some Budget Plan rows map to just hides that
                comparison — it won't affect your logged transactions.
              </div>
            </div>
            ...
            <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
              ...
              <div className={`text-[12px] ${textMuted} mb-4`}>
                Download a copy of your wallet
              </div>
              <div className="flex items-center gap-3 flex-wrap">
                <button
                  onClick={exportPDFSummary}
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-[13px] font-medium border ${border} ${textMuted} hover:${
                    dark ? 'bg-neutral-800' : 'bg-neutral-50'
                  }`}
                >
                  <FileText size={14} /> Export PDF Summary
              ...
              <div className={`text-[11px] ${textMuted} mt-3`}>
                The Excel file includes a Ledger sheet plus separate pivot-style
                analysis sheets (spend by category, income by source, payment
                method, monthly summary, budget vs actual). These are
                precomputed summary tables shaped like pivot table output —
                Excel's own interactive, draggable PivotTable objects aren't
                something this export can generate, so treat them as a finished
                report rather than something you rebuild the layout of inside
                Excel.
              </div>
            </div>
            ...
            <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
              <div className="flex items-center gap-3 mb-1">
                ...
                <div>
                  ...
                  <div className={`text-[12px] ${textMuted}`}>
                    Keep your wallet in sync across devices using a private
                    GitHub Gist
                  </div>
                </div>
              </div>
              ...
              <div
                className={`flex items-center gap-2 text-[12px] ${textMuted} my-3`}
              >
                <span
                  className={`w-1.5 h-1.5 rounded-full ${
                ...
                {cloudSyncStatus === 'disabled'
                  ? 'Not connected — your data stays local to this browser.'
                  : cloudSyncStatus === 'connecting'
                  ? 'Connecting…'
                  : cloudSyncStatus === 'syncing'
                  ? 'Syncing…'
                  : cloudSyncStatus === 'error'
                  ? "Couldn't reach GitHub — will retry on the next change."
                  : 'Synced.'}
              </div>
              ...
              {!cloudConnected ? (
                <>
                  ...
                  <label
                    className={`text-[12px] font-medium ${textMuted} mb-1 block`}
                  >
                    Gist ID (leave blank to create a new one)
                  </label>
                  <input
                    type="text"
                    value={gistId}
                ...
                <>
                  <div className="flex items-center gap-2 mb-4 flex-wrap">
                    ...
                    <button
                      onClick={() => {
                        ...
                        setSettingsMessage(
                          "Gist ID copied — paste it into your other device's Cloud Sync setup."
                        );
                      }}
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-[13px] font-medium border ${border} ${textMuted} hover:${
                        dark ? 'bg-neutral-800' : 'bg-neutral-50'
                      }`}
                    >
                      Sync Now
              ...
              <details className="mt-4">
                <summary
                  className={`text-[12px] font-medium cursor-pointer ${textMuted}`}
                >
                  How do I set this up?
                </summary>
                <div className={`text-[12px] ${textMuted} mt-2 space-y-1.5`}>
                  <p>
                    1. On GitHub, go to Settings → Developer settings → Personal
                    access tokens → Tokens (classic) → Generate new token, and
                    check only the <span className="font-medium">gist</span>{' '}
                    scope.
                  </p>
                  <p>
                    2. Paste that token above and click "Connect & Sync" with
                    the Gist ID left blank — this creates a new private gist and
                    shows you its ID.
                  </p>
                  <p>
                    3. On any other device, paste the{' '}
                    <span className="font-medium">same token</span> and that{' '}
                    <span className="font-medium">Gist ID</span>, then click
                    Connect — it'll offer to load the synced data.
                  </p>
                  <p>
                    Keep the token private — anyone who has it can read or write
                    that gist. Disconnecting here doesn't delete the gist
                    itself, so reconnecting later with the same ID picks up
            ...
            <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
              ...
              <div className={`text-[12px] ${textMuted} mb-4`}>
                Bring transactions in from a CSV, or restore a full CampCash
                JSON backup
              </div>
              ...
              <div className={`text-[11px] ${textMuted}`}>
                ...
                <span className="font-medium">
                  Date, Type (Income/Expense), Category, Amount, Notes, Payment
                  Method
                </span>{' '}
                — column order doesn't matter, extra columns are ignored. CSV
                import adds to your existing ledger; it never removes anything.
              </div>
            </div>
            ...
            <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
              ...
              <div className={`text-[12px] ${textMuted} mb-4`}>
                Loads about 3 months of realistic demo transactions — useful for
                trying out Analytics, the Budget Plan comparison, and month-end
                rollover without entering anything by hand. Adds to your
                existing ledger; nothing is overwritten.
              </div>
              <button
                onClick={loadSampleData}
                className={`px-4 py-2 rounded-lg text-[13px] font-medium border ${border} ${textMuted} hover:${
            ...
            >
              ...
              <div className={`text-[12px] ${textMuted} mb-4`}>
                Permanently clears every logged transaction, including the saved
                copy in this browser. Account name, currency, categories, and
                opening balance are kept.
              </div>
              {!resetConfirming ? (
                <button
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-[13px] font-medium bg-red-600 text-white hover:bg-red-700"
                  >
                    Confirm Reset
                  </button>
                  <button
      ...
      {lastDeleted && (
        <div
          className={`fixed bottom-5 left-1/2 -translate-x-1/2 z-30 rounded-lg border ${border} ${cardBg} shadow-lg px-4 py-3 flex items-center gap-4`}
        >
